...
"""this down written code is for test create and add new clinet co db - remember 
to import db_connection - there is a problem with SQLAlchemy connector - repair that and it should be good"""
